  ...
  render(){
    ...
    return(
      ...
      <div className="clock-container">
        <h1 className='label' id="timer-label">{currentTimer}</h1>
        <span className='time' id="time-left">{this.convertToTime(clockCount)}</span>
  ...
  return(
    ...
    <div className="container">
      ...
      <div className="length">
        ...
        <span className='display' id={`${id}-length`}>{props.count}</span>
